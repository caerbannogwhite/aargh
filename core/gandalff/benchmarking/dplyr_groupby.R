...
for (data_name in c("G1_1e4_1e2_0_0.csv", "G1_1e4_1e2_10_0.csv", "G1_1e5_1e2_0_0.csv", "G1_1e5_1e2_10_0.csv", "G1_1e6_1e2_0_0.csv", "G1_1e6_1e2_10_0.csv", "G1_1e7_1e2_0_0.csv", "G1_1e7_1e2_10_0.csv")) {
    src_grp <- file.path("..", "testdata", data_name)
